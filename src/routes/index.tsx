...
function Team() {
  const members = [
    {
      ...
      role: "Co-Founder & CEO",
      bio: "Former Director of Academic Systems at MIT. PhD in Computer Science from Stanford University.",
      initials: "AV",
      gradient: "from-[#5B4CFF] to-[#36CFC9]",
      links: { linkedin: "#", github: "#" }
    },
    {
      name: "Elena Rostova",
      role: "Co-Founder & Chief AI Architect",
      bio: "Former Lead Research Scientist at OpenAI. Specialist in LLMs and multi-agent systems for assessment.",
      initials: "ER",
      gradient: "from-[#36CFC9] to-[#8A7BFF]",
      links: { linkedin: "#", github: "#" }
    },
    {
      name: "Marcus Sterling",
      role: "Chief Product Officer",
      bio: "Former Principal Product Designer at Stripe and Palantir. BFA from Rhode Island School of Design.",
      initials: "MS",
      gradient: "from-[#8A7BFF] to-[#5B4CFF]",
      links: { linkedin: "#", github: "#" }
    }
  ];
  ...
  return (
    <section id="team" className="py-32 relative">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          <div className="text-xs uppercase tracking-[0.3em] text-[#36CFC9] mb-4 font-semibold">Who we are</div>
          <h2 className="text-4xl md:text-6xl font-bold tracking-tighter">Built by a <span className="gradient-text">world-class team</span></h2>
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            We are researchers, educators, and enterprise engineers building the future of higher education technology.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {members.map((member, i) => (
            <motion.div key={i}
              initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              transition={{ delay: i * 0.1 }}
              className="group relative rounded-2xl glass p-8 border border-border/40 hover:border-primary/40 transition-all duration-300 flex flex-col items-center text-center">
              
              {/* Profile Photo Circle */}
              <div className="relative mb-6">
                <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-[#5B4CFF] to-[#36CFC9] blur-md opacity-25 group-hover:opacity-40 transition-opacity duration-300" />
                <div className={`relative h-28 w-28 rounded-full bg-gradient-to-br ${member.gradient} p-[2px] shadow-lg group-hover:scale-105 transition-transform duration-300`}>
                  <div className="h-full w-full rounded-full bg-background flex items-center justify-center overflow-hidden">
                    {/* Circle Photo placeholder */}
                    <span className="text-3xl font-bold tracking-tight font-display bg-gradient-to-r from-white to-muted-foreground bg-clip-text text-transparent">
                      {member.initials}
                    </span>
                  </div>
                </div>
              ...
              <div className="text-sm font-medium text-[#36CFC9] mt-1 mb-4">
                {member.role}
              </div>
              ...
              <div className="flex items-center gap-4 mt-6">
                <a href={member.links.linkedin} className="text-muted-foreground hover:text-foreground transition-colors p-2 rounded-full hover:bg-white/5" aria-label="LinkedIn">
                  <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                  </svg>
                </a>
                <a href={member.links.github} className="text-muted-foreground hover:text-foreground transition-colors p-2 rounded-full hover:bg-white/5" aria-label="GitHub">
                  <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
                    <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 4.438 9.8 10.564 11.307.6.11.821-.26.821-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 3.513 1.305 4.372.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.22.694.825.576 6.105-1.503 10.53-6.001 10.53-11.307 0-6.627-5.373-12-12-12z"/>
                  </svg>
                </a>
              </div>
